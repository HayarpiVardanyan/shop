...
//                   <Link
//                     href='/catalog/accessories'
//                     className={`${styles.catagories__left__top__right} ${styles.categories__img} ${imgSpinnerClass}`}
//                   >
//                     <Image
//                       src={img2}
//                       alt='Accessories'
...
//                   <Link
//                     href='/catalog/souvenirs'
//                     className={`${styles.catagories__left__top__left} ${styles.categories__img} ${imgSpinnerClass}`}
//                   >
//                     <Image
//                       src={img3}
//                       alt='Souvenirs'
...
//                 <Link
//                   href='/catalog/office'
//                   className={`${styles.catagories__left__bottom} ${styles.categories__img} ${imgSpinnerClass}`}
//                 >
//                   <Image
//                     src={img4}
//                     alt='Office'
